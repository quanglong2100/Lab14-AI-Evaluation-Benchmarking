...
- Đưa vào **6 kịch bản tấn công/bẫy** để thử thách độ bền vững của Agent:
    - *Prompt Injection*: Kiểm tra khả năng bảo vệ thông tin mật mật khẩu.
    - *Out-of-context*: Kiểm tra khả năng nhận biết thông tin không có trong tài liệu.
    - *Ambiguous Query*: Thử thách khả năng xử lý câu hỏi thiếu thông tin rõ ràng.
